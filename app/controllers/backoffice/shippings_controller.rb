class Backoffice::ShippingsController < Backoffice::DashboardController
  ...
  def create
    ...
    respond_to do |format|
      if @shipping.save
        format.html { redirect_to backoffice_shippings_path, notice: "Shipping was successfully created." }
  ...
  private
    ...
    def shipping_params
      params.require(:shipping).permit(:name, :value, :status)
    end
end
